...
export default function HealthcareCampaignPage() {
  return (
    <main>
      <section className="relative bg-gradient-to-br from-green-50 to-white pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn>
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-[#5A6270] leading-tight mb-6">
              Healthcare <span className="text-[#1F3A6D]">Initiative</span>
            </h1>
            <p className="text-xl md:text-2xl text-[#5A6270] max-w-3xl mx-auto leading-relaxed">
              Bringing essential health services to 10,000 more people across Bunyoro — mobile clinics, trained health workers, and preventive care.
            </p>
          </FadeIn>
        </div>
      </section>
